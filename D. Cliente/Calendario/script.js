...
textoMes.textContent = meses[mesActual] + " - " + anyorActual; //cambiar texto
...
function generarDias() {
  ...
  for (let i = 0; i < 7; i++) {
    ...
    columna.classList.add("diaSemana");
    switch (i) {
      case 0:
        columna.textContent = "L";
        break;
      case 1:
        columna.textContent = "M";
        break;
      case 2:
        columna.textContent = "X";
        break;
      case 3:
        columna.textContent = "J";
        break;
      case 4:
        columna.textContent = "V";
        break;
      case 5:
        columna.textContent = "S";
        break;
      case 6:
        columna.textContent = "D";
        break;
    }
  ...
  for (let i = 0; i < semanas; i++) {
    ...
    filaDias.classList.add("diasMes");
    for (let j = 0; j < 7; j++) {
      let diaSemana;
      switch (j) {
        case 0:
      ...
      if (
        dia.getDate() == diaActual.getDate() &&
        dia.getMonth() == diaActual.getMonth() &&
        dia.getFullYear() == diaActual.getFullYear()
      ) {
